- Перед открывающей или закрывающей скобкой запятая, точка с запятой, двоеточие и тире не ставятся. Запятая, точка с запятой, двоеточие и тире ставятся только после закрывающей скобки:
