...
public class ColorPickerDialog extends DialogFragment implements ColorPickerView.OnColorChangedListener, TextWatcher {
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    if (selectedButtonStringRes == 0) {
      selectedButtonStringRes = R.string.colorpicker_select;
    }
    ...
    if (dialogType == TYPE_CUSTOM && getArguments().getBoolean(ARG_ALLOW_PRESETS)) {
      neutralButtonStringRes = (presetsButtonStringRes != 0 ? presetsButtonStringRes : R.string.colorpicker_presets);
    } else if (dialogType == TYPE_PRESETS && getArguments().getBoolean(ARG_ALLOW_CUSTOM)) {
      neutralButtonStringRes = (customButtonStringRes != 0 ? customButtonStringRes : R.string.colorpicker_custom);
    } else {
        ...
        public void onClick(View v) {
          ...
          switch (dialogType) {
            case TYPE_CUSTOM:
              ...
              ((Button) v).setText(customButtonStringRes != 0 ? customButtonStringRes : R.string.colorpicker_custom);
              rootView.addView(createPresetsView());
              break;
            case TYPE_PRESETS:
              dialogType = TYPE_CUSTOM;
              ((Button) v).setText(presetsButtonStringRes != 0 ? presetsButtonStringRes : R.string.colorpicker_presets);
              rootView.addView(createPickerView());
          }
        }
      });
  ...
  View createPickerView() {
    View contentView = View.inflate(getActivity(), R.layout.colorpicker_dialog_color_picker, null);
    colorPicker = (ColorPickerView) contentView.findViewById(R.id.colorpicker_color_picker_view);
    ColorPanelView oldColorPanel = (ColorPanelView) contentView.findViewById(R.id.colorpicker_color_panel_old);
    newColorPanel = (ColorPanelView) contentView.findViewById(R.id.colorpicker_color_panel_new);
  ...
  View createPresetsView() {
    View contentView = View.inflate(getActivity(), R.layout.colorpicker_dialog_presets, null);
  ...
  void createColorShades(@ColorInt final int color) {
    ...
    for (final int colorShade : colorShades) {
      ...
      if (colorShape == ColorShape.SQUARE) {
        layoutResId = R.layout.colorpicker_color_item_square;
      } else {
      ...
      colorPanelView.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
          ...
          for (int i = 0; i < shadesLayout.getChildCount(); i++) {
            ...
            ImageView iv = (ImageView) layout.findViewById(R.id.cpv_color_image_view);
            iv.setImageResource(cpv == v ? R.drawable.colorpicker_preset_checked : 0);
  ...
  public static final class Builder {
    ...
    @StringRes
    int presetsButtonText = R.string.colorpicker_presets;
    @StringRes
    int customButtonText = R.string.colorpicker_custom;
    @StringRes
    int selectedButtonText = R.string.colorpicker_select;
