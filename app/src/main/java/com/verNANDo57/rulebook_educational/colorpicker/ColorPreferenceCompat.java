...
public class ColorPreferenceCompat extends Preference implements ColorPickerDialogListener {
  ...
  private void init(AttributeSet attrs) {
    ...
    dialogTitle = a.getResourceId(R.styleable.ColorPreference_cpv_dialogTitle, R.string.colorpicker_default_title);
    if (presetsResId != 0) {
    ...
    if (colorShape == ColorShape.CIRCLE) {
      setWidgetLayoutResource(
          previewSize == SIZE_LARGE ? R.layout.colorpicker_preference_circle_large : R.layout.colorpicker_preference_circle);
    } else {
      setWidgetLayoutResource(
          previewSize == SIZE_LARGE ? R.layout.colorpicker_preference_square_large : R.layout.colorpicker_preference_square);
    }
    a.recycle();
  }
  ...
  public void onBindViewHolder(PreferenceViewHolder holder) {
    ...
    ColorPanelView preview = (ColorPanelView) holder.itemView.findViewById(R.id.colorpicker_preference_preview_color_panel);
    if (preview != null) {
