...
import com.verNANDo57.rulebook_educational.pdflib.pdfviewer.util.PageSizeCalculator;
...
public class PdfFile {
    ...
    public PdfDocument.Meta getMetaData(Context context) {
        if (pdfDocument == null) {
            return null;
        }
        return pdfiumCore.getDocumentMeta(pdfDocument, context);
    }
