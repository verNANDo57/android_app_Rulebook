...
public class BaseRecyclerViewAdapterTwo extends RecyclerView.Adapter<BaseRecyclerViewHolder> {

    public ArrayList<RuleItemData> listdata;
    public BaseRecyclerViewAdapterTwo(ArrayList<RuleItemData> listdata) {
