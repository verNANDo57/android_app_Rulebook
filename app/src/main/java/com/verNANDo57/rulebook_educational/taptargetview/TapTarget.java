...
public class TapTarget {
   ...
   */
  public static TapTarget forToolbarOverflow(BottomAppBar bottomAppBar, CharSequence title) {
    return forToolbarOverflow(bottomAppBar, title, null);
  }
  ...
  public static TapTarget forToolbarOverflow(BottomAppBar bottomAppBar, CharSequence title,
    ...
    return new BottomAppBarTapTarget(bottomAppBar, false, title, description);
  }

  /** Return a tap target for the navigation button (back, up, etc) from the given toolbar **/
  public static TapTarget forToolbarNavigationIcon(BottomAppBar bottomAppBar, CharSequence title) {
    return forToolbarNavigationIcon(bottomAppBar, title, null);
  }

  /** Return a tap target for the navigation button (back, up, etc) from the given toolbar **/
  public static TapTarget forToolbarNavigationIcon(BottomAppBar bottomAppBar, CharSequence title,
                                                   @Nullable CharSequence description) {
    return new BottomAppBarTapTarget(bottomAppBar, true, title, description);
  }

  /** Return a tap target for the menu item from the given toolbar **/
  public static TapTarget forToolbarMenuItem(BottomAppBar bottomAppBar, @IdRes int menuItemId,
                                             CharSequence title) {
    return forToolbarMenuItem(bottomAppBar, menuItemId, title, null);
  }

  /** Return a tap target for the menu item from the given toolbar **/
  public static TapTarget forToolbarMenuItem(BottomAppBar bottomAppBar, @IdRes int menuItemId,
                                                    CharSequence title, @Nullable CharSequence description) {
    return new BottomAppBarTapTarget(bottomAppBar, menuItemId, title, description);
  }
