...
class CustomThemeEngineLayoutInflater : LayoutInflater {
  ...
  var viewFactory: CustomThemeEngineViewFactory? = null
  var decorators: Array<CustomThemeEngineDecorator>? = null

  override fun cloneInContext(newContext: Context): LayoutInflater {
    val inflater = CustomThemeEngineLayoutInflater(this, newContext, true)
  ...
  /**
   * Method to dispatch our view and attributes to the [CustomThemeEngineViewFactory].
   * Called immediately after [onCreateView][CustomThemeEngineLayoutInflater.onCreateView]
   *
   * @param view
  ...
  companion object {
    ...
    internal var inflationDelegate: CustomThemeEngineInflationDelegate? = null
  }
}
